...
SECRET_KEY = 'django-insecure-ta8gq82b01&k6steedvt*g%p@0-3oq*&mads_7f1km*^on9dh('
...
# For development, we use SQLite. In production, we can switch to PostgreSQL using the DATABASE_URL environment variable.
